...
static int webusb_control_vendor_request(usbd_device *usbd_dev,
    ...
    switch (req->wIndex) {
        case WEBUSB_REQ_GET_ALLOWED_ORIGINS: {
            ...
            size_t i;
            size_t num_origins = webusb_num_http_urls+webusb_num_https_urls;
        ...
        case WEBUSB_REQ_GET_URL: {
            ...
            if (index < webusb_num_https_urls) {
                ...
                *len = url->bLength;
                status = USBD_REQ_HANDLED;
            } else if (index < webusb_num_https_urls + webusb_num_http_urls) {
                index -= webusb_num_https_urls;
...
void webusb_setup(usbd_device* usbd_dev,
                  const char** http_urls, size_t num_http_urls,
